...
//                                case .pause(let req):
//                                    if machines.map[req] != nil {
//                                        return (machines, [.int(true)], false)
//                                    } else {
//                                        // ignore
//                                        return (machines, [], false)
//                                    }
//                                case .resume(let req):
//                                    if machines.map[req] != nil {
//                                        return (machines, [.int(false)], false)
//                                    } else {
//                                        // ignore
//                                        return (machines, [], false)
//                                    }
...
//                                            
//                                            
//                                            // MARK: WE GOTTA HAVE LOGIC TO CHECK HOW MANY ARE PAUSED, AND HOW MANY ARE NOT PAUSED.
//                                        case .willPause(let tag2):
//                                            
//                                            break
//                                        case .willResume(let id):
//                                            break
//                                        case .willPauseAll:
//                                            break
//                                        case .willResumeAll:
