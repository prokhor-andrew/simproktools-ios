...
public extension Machine {
    ...
    static func pure(onProcess: @escaping (Input, MachineCallback<Output>, (Loggable) -> Void) async -> Void) -> Machine<Input, Output> {
        Machine { id, logger in
            ...
            await onProcess(input, callback, obj.logger)
        }
    }
}
